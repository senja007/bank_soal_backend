 ...
 * @author alfa
 */
public class QuizAnnouncementRequest {
    private String name;
    ...
    private int size_question; // Add this field


    public  QuizAnnouncementRequest(){
    }

    public  QuizAnnouncementRequest(String name, String description, List<String> questions, String rps_id, Integer min_grade, Integer duration,String message ,String type_quiz,Instant date_start, Instant date_end){
        this.name = name;
    ...
    public int getSizeQuestion() { // Add this getter
        return size_question;
    }

    public void setSizeQuestion(int size_question) { // Add this setter
        this.size_question = size_question;
    }
